...
class S3Backend(object):
    ...
    def get_object_manifest(self, object_name):
        ...
        # self.__client.put_object(Bucket='mybucket', Key=manifest_name, Body="random test")
        try:
    ...
    def stat_object(self, args, options):
        ...
        try:
            if not args:
                ...
                if int(stat_data['headers']['Metadata'].get('x-object-meta-segment-count', 0)) > 0:
